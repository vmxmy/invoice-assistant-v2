...
class ReimbursementSetStatusChangedEvent extends ReimbursementSetChangedEvent {
  ...
  @override
  String toString() =>
      'ReimbursementSetStatusChangedEvent(setId: $setId, $oldStatus -> $newStatus, invoices: ${affectedInvoiceIds.length})';
}
...
class InvoiceStatusSyncedEvent extends InvoiceChangedEvent {
  ...
  @override
  String toString() =>
      'InvoiceStatusSyncedEvent(invoices: ${invoiceIds.length}, $oldStatus -> $newStatus, setId: $reimbursementSetId)';
}
...
class StatusConsistencyCheckEvent extends AppEvent {
  ...
  @override
  String toString() =>
      'StatusConsistencyCheckEvent(setId: $reimbursementSetId)';
}
...
/// 创建报销集请求事件
class CreateReimbursementSetRequestEvent
    extends ReimbursementSetActionRequestEvent {
  ...
  @override
  String toString() =>
      'CreateReimbursementSetRequestEvent(setName: $setName, invoices: ${invoiceIds.length})';
}

/// 删除报销集请求事件
class DeleteReimbursementSetRequestEvent
    extends ReimbursementSetActionRequestEvent {
  final String setId;
  final DateTime timestamp;
...
class AddInvoicesToSetRequestEvent extends ReimbursementSetActionRequestEvent {
  ...
  @override
  String toString() =>
      'AddInvoicesToSetRequestEvent(setId: $setId, invoices: ${invoiceIds.length})';
}

/// 发票移出报销集请求事件
class RemoveInvoicesFromSetRequestEvent
    extends ReimbursementSetActionRequestEvent {
  final List<String> invoiceIds;
  final DateTime timestamp;
  ...
  @override
  String toString() =>
      'RemoveInvoicesFromSetRequestEvent(invoices: ${invoiceIds.length})';
}
...
class DeleteInvoicesRequestEvent extends InvoiceActionRequestEvent {
  ...
  @override
  String toString() =>
      'DeleteInvoicesRequestEvent(invoices: ${invoiceIds.length})';
}

/// 报销集更新请求事件
class UpdateReimbursementSetRequestEvent
    extends ReimbursementSetActionRequestEvent {
  final String setId;
  final String setName;
  final String? description;
  ...
  @override
  String toString() =>
      'UpdateReimbursementSetRequestEvent(setId: $setId, name: $setName)';
}

/// 报销集状态更新请求事件
class UpdateReimbursementSetStatusRequestEvent
    extends ReimbursementSetActionRequestEvent {
  final String setId;
  ...
  @override
  String toString() =>
      'UpdateReimbursementSetStatusRequestEvent(setId: $setId, status: $newStatus)';
}
...
class UpdateInvoiceStatusRequestEvent extends InvoiceActionRequestEvent {
  ...
  @override
  String toString() =>
      'UpdateInvoiceStatusRequestEvent(invoiceId: $invoiceId, status: $newStatus)';
}
