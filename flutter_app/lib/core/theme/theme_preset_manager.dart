  ...
  static Future<void> loadPresets() async {
    ...
    try {
      ...
      _presets = presetsData
          .map((data) => ThemePlaygroundPreset.fromJson(data))
          .toList();
...
class ThemePlaygroundPreset {
  ...
  FlexSchemeColor? get customFlexSchemeColorLight {
    ...
    return FlexSchemeColor(
      ...
      secondaryContainer:
          Color(int.parse(colors['secondaryContainer'] as String)),
      tertiary: Color(int.parse(colors['tertiary'] as String)),
      tertiaryContainer:
          Color(int.parse(colors['tertiaryContainer'] as String)),
  ...
  FlexSchemeColor? get customFlexSchemeColorDark {
    ...
    return FlexSchemeColor(
      ...
      primaryContainer:
          Color(int.parse(colors['primaryContainerDark'] as String)),
      primaryLightRef: Color(int.parse(colors['primaryLightRef'] as String)),
      secondary: Color(int.parse(colors['secondaryDark'] as String)),
      secondaryContainer:
          Color(int.parse(colors['secondaryContainerDark'] as String)),
      secondaryLightRef:
          Color(int.parse(colors['secondaryLightRef'] as String)),
      tertiary: Color(int.parse(colors['tertiaryDark'] as String)),
      tertiaryContainer:
          Color(int.parse(colors['tertiaryContainerDark'] as String)),
  ...
  factory ThemePlaygroundPreset.fromJson(Map<String, dynamic> json) {
    return ThemePlaygroundPreset(
      ...
      inputDecoratorBorderType:
          _parseInputBorderType(json['inputDecoratorBorderType'] as String?),
      alignedDropdown: json['alignedDropdown'] as bool? ?? true,
      navigationRailUseIndicator:
          json['navigationRailUseIndicator'] as bool? ?? false,
  ...
  static FlexInputBorderType _parseInputBorderType(String? borderTypeName) {
    ...
    try {
      return FlexInputBorderType.values
          .firstWhere((t) => t.name == borderTypeName);
    } catch (e) {
      AppLogger.debug('⚠️ 未知的 inputBorderType: $borderTypeName, 使用默认值',
          tag: 'Debug');
