...
class CupertinoSemanticColors {
  ...
  /// 报销集相关操作
  static const CupertinoDynamicColor reimbursementSet =
  ...
  /// 占位符状态
  static const CupertinoDynamicColor placeholder =
  ...
  static Color resolveColor(
      CupertinoDynamicColor dynamicColor, BuildContext context) {
    return dynamicColor.resolveFrom(context);
  }

  /// 为颜色添加透明度（保持语义性）
  static CupertinoDynamicColor withAlpha(
      CupertinoDynamicColor color, double alpha) {
