...
class AppTypography {
  ...
  static TextStyle headlineLarge(BuildContext context) {
    return _getTextTheme(context).headlineLarge ??
        const TextStyle(
          fontSize: 28,
  ...
  static TextStyle headlineMedium(BuildContext context) {
    return _getTextTheme(context).headlineMedium ??
        const TextStyle(
          fontSize: 24,
  ...
  static TextStyle headlineSmall(BuildContext context) {
    return _getTextTheme(context).headlineSmall ??
        const TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.w600,
          letterSpacing: 0,
  ...
  static TextStyle titleLarge(BuildContext context) {
    return _getTextTheme(context).titleLarge ??
        const TextStyle(
          fontSize: 18,
          fontWeight: FontWeight.w600,
          letterSpacing: 0,
  ...
  static TextStyle titleMedium(BuildContext context) {
    return _getTextTheme(context).titleMedium ??
        const TextStyle(
          fontSize: 16,
  ...
  static TextStyle titleSmall(BuildContext context) {
    return _getTextTheme(context).titleSmall ??
        const TextStyle(
          fontSize: 14,
          fontWeight: FontWeight.w500,
          letterSpacing: 0.1,
  ...
  static TextStyle bodyLarge(BuildContext context) {
    return _getTextTheme(context).bodyLarge ??
        const TextStyle(
          fontSize: 16,
  ...
  static TextStyle bodyMedium(BuildContext context) {
    return _getTextTheme(context).bodyMedium ??
        const TextStyle(
          fontSize: 14,
          fontWeight: FontWeight.w400,
          letterSpacing: 0.2,
  ...
  static TextStyle bodySmall(BuildContext context) {
    return _getTextTheme(context).bodySmall ??
        const TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w400,
          letterSpacing: 0.4,
  ...
  static TextStyle labelLarge(BuildContext context) {
    return _getTextTheme(context).labelLarge ??
        const TextStyle(
          fontSize: 14,
          fontWeight: FontWeight.w500,
          letterSpacing: 0.1,
  ...
  static TextStyle labelMedium(BuildContext context) {
    return _getTextTheme(context).labelMedium ??
        const TextStyle(
          fontSize: 12,
          fontWeight: FontWeight.w500,
          letterSpacing: 0.5,
  ...
  static TextStyle labelSmall(BuildContext context) {
    return _getTextTheme(context).labelSmall ??
        const TextStyle(
          fontSize: 11,
          fontWeight: FontWeight.w500,
          letterSpacing: 0.5,
  ...
  static TextStyle displayLarge(BuildContext context) {
    return _getTextTheme(context).displayLarge ??
        const TextStyle(
          fontSize: 36,
          fontWeight: FontWeight.w700,
          letterSpacing: -0.8,
  ...
  static TextStyle displayMedium(BuildContext context) {
    return _getTextTheme(context).displayMedium ??
        const TextStyle(
          fontSize: 32,
          fontWeight: FontWeight.w600,
          letterSpacing: -0.6,
  ...
  static TextStyle displaySmall(BuildContext context) {
    return _getTextTheme(context).displaySmall ??
        const TextStyle(
          fontSize: 28,
          fontWeight: FontWeight.w600,
          letterSpacing: -0.4,
