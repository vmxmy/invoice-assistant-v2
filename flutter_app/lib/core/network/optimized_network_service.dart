...
class OptimizedNetworkService {
  static final OptimizedNetworkService _instance = OptimizedNetworkService._internal();
  ...
  /// 处理单个端点的请求批次
  Future<void> _processEndpointBatch(String endpoint, List<_QueuedRequest> requests) async {
    // 限制并发数量
  ...
  Duration _getAdaptiveTimeout(String endpoint) {
    ...
    final adaptiveTimeout = Duration(milliseconds: (avgResponseTime * 3).toInt());
